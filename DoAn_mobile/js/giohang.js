    ...
    s += `
			...
			<tr>
				<td colspan="5">
                    ...
                    <form action="../Doan_mobile/vnpay_php/layout.php" method="get" class="btn btn-primary">
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-secondary" data-dismiss="modal">Thanh toán bằng VNPAY</button>
                      </div>
                </form>
